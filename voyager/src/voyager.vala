...
private class Program : Gtk.Application
{
    ...
    private Program()
    {
        Object(application_id: "org.vala-apps.voyager", flags: ApplicationFlags.HANDLES_OPEN);
    ...
    {
        pixbuf_scaled = pixbuf_scaled.rotate_simple(Gdk.PixbufRotation.COUNTERCLOCKWISE);
        image.set_from_pixbuf(pixbuf_scaled);
    }
